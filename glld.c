static void
opengl_get_version(GLint* Major, GLint* Minor)
{
...
static void
opengl_load_core(void)
{
	GLint Major, Minor;
	opengl_get_version(&Major, &Minor);
